...
public class StartScenePresenter : MonoBehaviour
{
    ...
    async void Start()
    {
        ...
        AudioManager.Instance.PlayBGM(AudioManager.BGMType.Start);

        startSceneView.SetStartButton(()=>
        LoadSceneUtility.Instance.StartLoadScene(LoadSceneUtility.SceneTypes.InGameScene));
    }
}
